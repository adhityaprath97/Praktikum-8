...
<h1>List Buku</h1>
<a href="buku/create"><button class="btn btn-primary">Tambah Buku</button></a>
<div class="container">
	<table id="example" class="table table-hover table-bordered" style="margin:10px;width: 80%">
		...
		<?php foreach($buku as $val): ?>
			<tr>
				...
				<td>
					<a href="buku/edit/<?php echo $val['kd_register']; ?>"><button class="btn btn-xs btn-info"><i class="fa fa-edit"></i> Edit</button></a>
					<button onclick="hapus(<?php echo $val['kd_register']; ?>)" class="btn btn-xs btn-info"><i class="fa fa-thrash"></i> Hapus</button>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
