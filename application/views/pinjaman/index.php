...
<h1>List Pinjaman</h1>
<a href="pinjaman/create"><button class="btn btn-primary">Buat Pinjaman</button></a>
<div class="container">	
	...
	<table class="table table-hover table-bordered" style="margin:10px;width: 80%">
		...
		<?php foreach($pinjaman as $val): ?>			
			<tr class="num" id="<?php echo $i; ?>" style="<?php if($i>10) echo 'display: none'; ?> ">
				...
				<td>
					<a href="pinjaman/edit/<?php echo $val['kd_pinjam']; ?>"><button class="btn btn-xs btn-info"><i class="fa fa-edit"></i> Edit</button></a>
					<button onclick="hapus(<?php echo $val['kd_pinjam']; ?>)" class="btn btn-xs btn-info"><i class="fa fa-thrash"></i> Hapus</button>
				</td>
			</tr>
			<?php $i++; ?>
		<?php endforeach; ?>
